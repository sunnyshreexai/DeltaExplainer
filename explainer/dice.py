...
from constants import BackEndTypes, SamplingStrategy
...
def decide(model_interface, method):
    ...
    if method == SamplingStrategy.Random:
        ...
        from explainer_interfaces.dice_random import DiceRandom
        return DiceRandom
    elif method == SamplingStrategy.Genetic:
        from explainer_interfaces.dice_genetic import DiceGenetic
        return DiceGenetic
    elif method == SamplingStrategy.KdTree:
        from explainer_interfaces.dice_KD import DiceKD
        return DiceKD
        ...
        if model_interface.backend == BackEndTypes.Tensorflow1:
            ...
            from explainer_interfaces.dice_tensorflow1 import \
                DiceTensorFlow1
            ...
            from explainer_interfaces.dice_tensorflow2 import \
                DiceTensorFlow2
            return DiceTensorFlow2

        elif model_interface.backend == BackEndTypes.Pytorch:
            # PyTorch backend
            from explainer_interfaces.dice_pytorch import DicePyTorch
            return DicePyTorch
        else:
            raise UserConfigValidationException(
        ...
        module = __import__("explainer_interfaces." + module_name, fromlist=[class_name])
